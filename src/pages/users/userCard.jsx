...
import { Button, Tag, Tooltip, Modal, Flex, message } from "antd";
...
export const UserCard = ({ user }) => {
  ...
  return (
    <Flex
      ...
      wrap
      gap={24}
      className="border border-dark p-2 rounded-md bg-accent justify-center  md:justify-between"
    >
      ...
      <Flex
        wrap
        gap={24}
        className="w-full max-w-3xl justify-center md:justify-normal"
      >
